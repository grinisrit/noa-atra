...
fun loadAllTrades(): List<Trade> {
    ...
    val col = mongo.getDatabase("bitstamp").getCollection<TimestampedMarketTrade>("trade")

    val res = col.find(TimestampedMarketTrade::platform_data / Trade::channel eq "live_trades_btcusd")
